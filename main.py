#   Atividade 5: Processamento de imagens - arquivos e filtros
#   Arquivo: main.py
#   Autor: Cinthia Alves Barreto, Isabel Cavalcante Motta, Isabella Rubio Venancio#
#   Date: 21/11/2023
#   Requisitos da aplicação: A aplicação deverá conter uma GUI que possibilita ao usuário a realização das seguintes operações básicas sobre a imagem:  
#       1)Ler uma imagem digital colorida(fornecida pelo usuário)
#       2)Criar um histograma da imagem
#       3)Transformar a imagem em padrões de cinza e também em binário (“black white”)
#       4)Aplicar alguns tipos de filtros (escolher 2).Por exemplo: passa-baixa, passa-alta, etc.
#       5)Gravar asimagens alteradas. Devem ter 5 arquivos correspondentes a esta atividade.
...
def distorcao_barril(imagem, intensidade=0.9):
